...
\author{%
  \texorpdfstring{%
    ...
    \IEEEauthorblockA{Astronomical Calculation Institute (ZAH--ARI)\\University of Heidelberg\\\texttt{sladen@ari.uni-heidelberg.de}}
}{Paul Sladen}}
\maketitle
...
significant contributing factor~\cite{riab-2010,riab-2013}. Yet,
...
been applied~\cite{osm-wiki-chunnel,sladen-sotm2013}. Academic publications cover two
